    ...
    <table class="table table-striped">
        ...
        <tbody>
            @forelse($orders as $order)
                <tr>
                    <td><input type="text" class="form-control" name="title" value="{{$order->title or ""}}" form="form-{{$order->id}}" required></td>
                    <td>
                        <select class="form-control" name="status_order" form="form-{{$order->id}}">
